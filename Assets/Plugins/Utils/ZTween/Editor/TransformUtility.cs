...
{
	static public TransformUtility instance;
	...
	{
		TweenEditorUtility.SetLabelWidth (15f);
	...
	void DrawRotation (bool isWidget)
	{
		GUILayout.BeginHorizontal ();
		{
			...
			if (reset) {
				...
				TweenEditorUtility.RegisterUndo ("Change Rotation", serializedObject.targetObjects);
